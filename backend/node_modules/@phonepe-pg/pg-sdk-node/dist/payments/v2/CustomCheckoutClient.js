...
const PgPaymentFlow_1 = require("./models/request/PgPaymentFlow");
const PgV2InstrumentType_1 = require("../../common/models/PgV2InstrumentType");
...
class CustomCheckoutClient extends BaseClient_1.BaseClient {
    constructor(clientId, clientSecret, clientVersion, env, shouldPublishEvents) {
        ...
        this.pay = (payRequest) => __awaiter(this, void 0, void 0, function* () {
            ...
            const isPciInstrument = (request) => {
                var _a;
                if (!(request.paymentFlow instanceof PgPaymentFlow_1.PgPaymentFlow))
                    return false;
                const type = (_a = request.paymentFlow.paymentMode) === null || _a === void 0 ? void 0 : _a.type;
                return type === PgV2InstrumentType_1.PgV2InstrumentType.CARD || type === PgV2InstrumentType_1.PgV2InstrumentType.TOKEN;
            };
            const request = isPciInstrument(payRequest)
                ? this.requestViaAuthRefreshPci(HttpMethodType_1.HttpMethodType.POST, url, CustomCheckoutPayResponse_1.CustomCheckoutPayResponse, headers, payRequest)
                : this.requestViaAuthRefresh(HttpMethodType_1.HttpMethodType.POST, url, CustomCheckoutPayResponse_1.CustomCheckoutPayResponse, headers, payRequest);
            try {
