...
class StandardCheckoutPayRequest {
    constructor(merchantOrderId, amount, metaInfo, message, redirectUrl, expireAfter, disablePaymentRetry, prefillUserLoginDetails) {
...
class StandardCheckoutPayRequestBuilder {
    constructor() {
        ...
        this.build = () => {
            return new StandardCheckoutPayRequest(this._merchantOrderId, this._amount, this._metaInfo, this._message, this._redirectUrl, this._expireAfter, this._disablePaymentRetry, this._prefillUserLoginDetails);
        };
    }
}
